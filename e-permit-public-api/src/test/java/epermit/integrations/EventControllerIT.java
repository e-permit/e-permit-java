...
public class EventControllerIT {
    ...
    @Container
    public static PostgreSQLContainer<CustomPostgresContainer> postgreSQLContainer =
    ...
    public void createTest() {
        ...
        ResponseEntity<EventHandleResult> result =
                this.restTemplate.postForEntity(uri, request, EventHandleResult.class);
